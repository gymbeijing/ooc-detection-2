...
if __name__ == '__main__':
    ...
    train_data = TwitterCOMMsDataset(csv_path='../raw_data/train_completed.csv',
                                    ...
                                    #  multimodal_embeds_path=root_dir+f'twitter-comms/processed_data/tensor/{base_model}_{mode}_embeds_train.pt',
                                     multimodal_embeds_path=root_dir+f'twitter-comms/processed_data/tensor/{base_model}_{mode}_embeds_train_original.pt',
                                    ...
                                    metadata_path=root_dir+f'twitter-comms/processed_data/metadata/{base_model}_{mode}_idx_to_image_path_train_original.json')
