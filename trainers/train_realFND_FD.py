...
"""
python -m trainers.train_realFND_FD --batch_size 256 --event_num 4 --max_epochs 10 --hidden_dim 768 --base_model blip-2 --threshold 0.5 --few_shot_topic military
"""
...
if __name__ == '__main__':
    ...
    val_iterator = data.DataLoader(val_data,
                                   shuffle=False,
                                   batch_size=BATCH_SIZE)
    train_iterator = data.DataLoader(val_data,
                                     shuffle=True,
                                     batch_size=BATCH_SIZE)
    ...
    # torch.save(fake_news_classifier.state_dict(), os.path.join('real_fnd_output' 'fake_news_classifier.ckpt'))
