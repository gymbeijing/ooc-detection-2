...
if __name__ == '__main__':
    ...
    negative_df = pd.read_feather('./raw_data/train_completed_exist_negative.feather')
    ...
    train_triplet_df = pd.concat([train_df, negative_df.filename_negative], axis=1)
    train_triplet_df = train_triplet_df.dropna().reset_index()
    train_triplet_df.to_feather('./raw_data/train_completed_exist_gaussian_blur_triplet.feather')
