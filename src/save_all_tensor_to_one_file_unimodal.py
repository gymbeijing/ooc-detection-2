...
if __name__ == '__main__':
    ...
    logger.info(f"Saving text tensor to {root_dir}tensor/{base_model}_{mode}_text_embeds_{phase}.pt")
    save_tensor(text_feature_tensor,
                root_dir+f'tensor/{base_model}_{mode}_text_embeds_{phase}.pt')
    logger.info(f"Saving image tensor to {root_dir}tensor/{base_model}_{mode}_image_embeds_{phase}.pt")
    save_tensor(image_feature_tensor,
                root_dir+f'tensor/{base_model}_{mode}_image_embeds_{phase}.pt')
    logger.info(f"Saving dictionary to {root_dir}metadata/{base_model}_{mode}_idx_to_image_path_{phase}.json")
