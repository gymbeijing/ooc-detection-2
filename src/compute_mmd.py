...
if __name__ == '__main__':
    cfg = ConfigConDA()
    src_train_loader, src_train_dataset_size = get_dataloader(cfg, few_shot_topic=['covid'], shuffle=True, phase="train")
    tgt_train_loader, tgt_train_dataset_size = get_dataloader(cfg, few_shot_topic=['military', 'climate'], shuffle=True, phase="train")
