...
def get_dataloader(cfg, few_shot_topic, shuffle, phase='val'):
    ...
    if phase == 'train':
        ...
        toy_dataset = TwitterCOMMsDatasetConDATriplet(triplet_feather_path='./raw_data/train_completed_exist_gaussian_blur_triplet.feather',
                                               img_dir=root_dir + 'twitter-comms/train/images/train_image_ids',
                                            #    original_multimodal_embeds_path=root_dir + f'twitter-comms/processed_data/tensor/{cfg.args.base_model}_multimodal_embeds_toy_original.pt',
                                               original_multimodal_embeds_path=root_dir + f'twitter-comms/processed_data/tensor/{cfg.args.base_model}_multimodal_embeds_train_original.pt',
                                            ...
                                            #    positive_multimodal_embeds_path=root_dir + f'twitter-comms/processed_data/tensor/{cfg.args.base_model}_multimodal_embeds_toy_synonym_replacement_GaussianBlur.pt',
                                               positive_multimodal_embeds_path=root_dir + f'twitter-comms/processed_data/tensor/{cfg.args.base_model}_multimodal_embeds_train_GaussianBlur.pt',
                                            #    negative_multimodal_embeds_path=root_dir + f'twitter-comms/processed_data/tensor/{cfg.args.base_model}_multimodal_embeds_toy_negative.pt',
                                               negative_multimodal_embeds_path=root_dir + f'twitter-comms/processed_data/tensor/{cfg.args.base_model}_multimodal_embeds_train_negative.pt',
